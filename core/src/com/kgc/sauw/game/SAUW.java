...
import com.kgc.sauw.game.os.SeedAnalyzerCommand;
import com.kgc.sauw.game.os.TimeCommand;
...
public class SAUW implements Screen {
    ...
    public SAUW() {
        ...
        sauwos.commandRegistry.register(new SeedAnalyzerCommand());
        sauwos.commandRegistry.register(new TimeCommand());
        sauwos.start();
